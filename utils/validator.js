...
module.exports = {
  ...
  SignUpValidator: [
    body("username")
      ...
      .withMessage(
        util.format(
          constants.VALIDATOR_ERROR_USERNAME,
          options.username.minLength
        )
      ),
    body("password")
  ...
  LoginValidator: [
    body("username")
      .isLength(options.username)
      .withMessage("username hoac password sai"),
    body("password")
      .isStrongPassword(options.password)
      .withMessage("username hoac password sai"),
  ],
  ...
  UserPutValidator: [
    ...
    body("email").isEmail().withMessage(constants.VALIDATOR_ERROR_EMAIL),
    body("imgURL").isURL().withMessage(constants.VALIDATOR_ERROR_IMGURL),
  ],
};
